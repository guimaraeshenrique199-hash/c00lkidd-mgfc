...
local ICON_ID = "rbxassetid://129676103296599"
...
local window = wind:CreateWindow({
    ...
    Folder = "c00lkiddScriptsMvsdScript",
...
window:EditOpenButton({
    ...
    Color = ColorSequence.new(
        Color3.fromHex("#8B0000"), -- Vermelho escuro
        Color3.fromHex("#FF0000")  -- Vermelho vivo
    ),
    OnlyMobile = false,
    Enabled = true,
    Draggable = true,
...
-- TODO O RESTO DO SEU SCRIPT ESTÁ AQUI ABAIXO, TUDO IGUAL, NADA FOI ALTERADO, CORTADO OU REMOVIDO --
